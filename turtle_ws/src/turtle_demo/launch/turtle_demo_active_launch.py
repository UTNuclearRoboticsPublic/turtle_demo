...
def namespace_launch(context):
    ...
    for i in range(int(num_groups)):
        ...
        turtle_BT = Node(
            ...
            namespace=namespace,
            output='screen',
            arguments=['/home/sheenan/thesis/turtle_ws/src/turtle_demo/behavior_trees/turtle_tree.xml'],
        ...
        launch_groups += [
            ...
            Node(
                ...
                namespace=namespace,
                parameters=[
                    {'csv_path' : '/home/sheenan/thesis/turtle_active_hide.csv'}
                ]
            ),
            Node(
                package='turtle_demo',
                executable='turtle_active_autopilot',
